                        ...
                        <div class="col-lg-12">
                            <div class="text-white">
                                <h1 class="mb-4"><span class="text-info">Let us</span><br>
                                    Guide you Find Your <span class="text-info">#DreamCollection</span><br></h1>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            <div class="form-group">
                                                <select name="max" class="form-control" required>
                                                    ...
                                                    <option value="">maximumu price</option>
                                                    <option value="5000">5k</option>
                                                    <option value="10000">10k</option>
                                                    <option value="15000">15k</option>
                                                    <option value="20000">20k</option>
...
<div class="img-wrapper">
    <div class="imgfilter_grediant">
        ...
        <div class="imgfilter_img">
            <img class="inner-img inner-img-appartment" src="newsectionimg/appartment.png"  style="object-fit: cover" height="350px" width="390" />
        </div>
...
<div class="img-wrapper">
    <div class="imgfilter_grediant imgfilter_grediant2">
        ...
        <div class="imgfilter_img">
            <img class="inner-img" src="newsectionimg/house.png"  style="object-fit: cover"  height="350px" width="380px" />
        </div>
    </div>
</div>
...
<div class="img-wrapper">
    <div class="imgfilter_grediant imgfilter_grediant">
        ...
        <div class="imgfilter_img">
            <img class="inner-img" src="newsectionimg/flate.png" style="object-fit: cover" height="350px" width="290" />
        </div>
    </div>
</div>
...
<div class="img-wrapper">
    ...
    <?php } ?>
    <div class="imgfilter_img">
        <img class="inner-img" src="newsectionimg/modern-villa.png" style="object-fit: cover" height="350px" width="290" />
    </div>
    </div>
</div>
...
<div class="img-wrapper">
    <div class="imgfilter_grediant">
        ...
        <div class="imgfilter_img">
            <img class="inner-img" src="newsectionimg/buildings.png" style="object-fit: cover" height="350px" width="290" />
        </div>
    </div>
</div>
<!-- this div for villa type -->
            ...
            <div class="bhkdiv col-lg-12 col-md-6 col-sm-3 mb-5">
