        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- <nav class="navbar navbar-expand-lg bg-body-tertiary"><a class="navbar-brand position-relative  " href="index.php"> -->
                            <div class="navlogo-main">
                                <!-- <h2 class="navtext navt1">Dream Collection</h2> -->
                                <!-- <img class="navlogo" src="images/logo/hlogo.png" alt=""> -->
                                <!-- <h2 class="navtext navt2">House</h2> -->
                                <p class="hlogo" style="color: black;font-weight: bold;text-transform: uppercase; text-align: center;font-family: cursive;align-items: center;" >Dream Collection <br> <span style="color: cadetblue;">Realestate</span></p>
                            </div>
                        </a>
